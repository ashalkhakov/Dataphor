...
namespace Alphora.Dataphor.DAE.Runtime.Instructions
{
    ...
    public class SeedNode : InstructionNode
	{
        ...
        public static void InternalExecute()
        {
            lock (typeof(SeedNode))
            {
                _random = new Random();
        ...
        public static void InternalExecute(int? argument1)
        {
            lock (typeof(SeedNode))
            {
                _random = new Random((int)argument1);
            }
        }
    }
    ...
    public class DecimalRandomNode : NilaryInstructionNode
	{
        ...
        public static decimal? InternalExecute()
        {
            return SeedNode.NextDecimal();
        }
    }
